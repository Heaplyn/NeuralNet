...
This run used 60,000 training images and 10,000 held-out test images. Meta-LR and Taylor-LR are the live adaptive multipliers reported by the trainer:

```text
[MNIST] Training on 60000 real images and evaluating on 10000 held-out images.
  MNIST epoch 1 | Loss: 1.4701 | Held-out accuracy: 74.0% | Meta LR: 1.005 | Taylor LR: 1.167
  MNIST epoch 2 | Loss: 0.7192 | Held-out accuracy: 87.3% | Meta LR: 1.004 | Taylor LR: 0.800
  MNIST epoch 4 | Loss: 0.4338 | Held-out accuracy: 89.1% | Meta LR: 0.972 | Taylor LR: 0.852
  MNIST epoch 6 | Loss: 0.3473 | Held-out accuracy: 91.3% | Meta LR: 0.942 | Taylor LR: 1.064
  MNIST epoch 8 | Loss: 0.3178 | Held-out accuracy: 92.6% | Meta LR: 0.954 | Taylor LR: 0.744
  MNIST epoch 10 | Loss: 0.2749 | Held-out accuracy: 92.6% | Meta LR: 0.970 | Taylor LR: 1.055
  MNIST epoch 12 | Loss: 0.2324 | Held-out accuracy: 92.5% | Meta LR: 0.992 | Taylor LR: 1.028
  MNIST epoch 14 | Loss: 0.2013 | Held-out accuracy: 94.4% | Meta LR: 1.001 | Taylor LR: 1.040
  MNIST epoch 16 | Loss: 0.1922 | Held-out accuracy: 94.5% | Meta LR: 0.957 | Taylor LR: 0.990
  MNIST epoch 18 | Loss: 0.1807 | Held-out accuracy: 94.7% | Meta LR: 0.962 | Taylor LR: 1.035
  MNIST epoch 20 | Loss: 0.1807 | Held-out accuracy: 95.2% | Meta LR: 0.979 | Taylor LR: 1.032
  MNIST epoch 22 | Loss: 0.1463 | Held-out accuracy: 95.4% | Meta LR: 0.999 | Taylor LR: 1.021
  MNIST epoch 24 | Loss: 0.1383 | Held-out accuracy: 95.7% | Meta LR: 1.000 | Taylor LR: 0.857
  MNIST epoch 26 | Loss: 0.1326 | Held-out accuracy: 96.2% | Meta LR: 0.986 | Taylor LR: 0.912
  MNIST epoch 28 | Loss: 0.1305 | Held-out accuracy: 96.4% | Meta LR: 0.972 | Taylor LR: 0.990
  MNIST epoch 30 | Loss: 0.1076 | Held-out accuracy: 96.5% | Meta LR: 0.994 | Taylor LR: 0.958
  MNIST epoch 32 | Loss: 0.0891 | Held-out accuracy: 95.9% | Meta LR: 1.004 | Taylor LR: 1.019
  MNIST epoch 34 | Loss: 0.0795 | Held-out accuracy: 96.5% | Meta LR: 0.996 | Taylor LR: 0.986
  MNIST epoch 36 | Loss: 0.0729 | Held-out accuracy: 97.3% | Meta LR: 0.971 | Taylor LR: 1.014
  MNIST epoch 38 | Loss: 0.0600 | Held-out accuracy: 97.2% | Meta LR: 1.003 | Taylor LR: 0.969
  MNIST epoch 40 | Loss: 0.0546 | Held-out accuracy: 97.3% | Meta LR: 1.004 | Taylor LR: 0.982
  MNIST epoch 42 | Loss: 0.0491 | Held-out accuracy: 97.5% | Meta LR: 0.998 | Taylor LR: 1.012
  MNIST epoch 44 | Loss: 0.0474 | Held-out accuracy: 97.6% | Meta LR: 1.004 | Taylor LR: 0.948
  MNIST epoch 46 | Loss: 0.0444 | Held-out accuracy: 97.6% | Meta LR: 1.005 | Taylor LR: 1.008
  MNIST epoch 48 | Loss: 0.0392 | Held-out accuracy: 97.8% | Meta LR: 1.005 | Taylor LR: 0.983
  MNIST epoch 50 | Loss: 0.0314 | Held-out accuracy: 97.6% | Meta LR: 1.005 | Taylor LR: 1.007
```
...
The best displayed result in this run is **97.8% held-out accuracy** at epoch 48. The Meta LR and Taylor LR values are multipliers around the configured base learning rate; they are not replacement learning-rate values.
